...
exports.handler = async function (event: any) {
    ...
    */
    let urls: [] = constants["URL_TO_CHECK"]
    let result: any = {};
    for (let i = 0; i < urls.length; i++) {
        ...
        cw.PublishData(constants["NAMESPACE"], constants["METRIC_NAME_AVAILABLILTY"], urls[i], availability)
        cw.PublishData(constants["NAMESPACE"], constants["METRIC_NAME_LATENCY"], urls[i], latency)
